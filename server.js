...
app.get("/events", async (req, res) => {
    ...
    .post(
      ...
      body, // Axios automatically stringifies JSON
      {
        headers: {
          ...
          Referer: `https://events.pokemon.com/EventLocator/Home?iskm=false&longitude=${longi}&latitude=${lati}&locale=en-US&range=100`,
        },
      }
    )
    .then((response) => {
  ...
  const getEventsFromStore = (
    ...
    eventsFromStoreBody.screenData.variables.range = "100";
    eventsFromStoreBody.screenData.variables.storename = storeName;

    eventsFromStoreBody.clientVariables.Range = "100";
